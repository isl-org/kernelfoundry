...
- A base task interface (``kernelfoundry.test_base.TestBase``) for implementing task-specific build and pytest test logic.
...
1. Create a task test class by deriving from `kernelfoundry.test_base.TestBase`.
